...
import { FaBars, FaTachometerAlt, FaUserMd, FaUsers, FaClipboardList, FaWpforms, FaHistory, FaHome, FaStar, FaCreditCard, FaComments, FaNewspaper } from 'react-icons/fa';
...
const Sidebar = ({ role }) => {
  ...
  const doctorLinks = [
    ...
    { path: '/doctor/blog', label: 'Blogs', icon: <FaNewspaper /> },
